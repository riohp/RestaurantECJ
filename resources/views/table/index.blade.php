                    ...
                    <form
                        ...
                        <button type="submit"
                            ...
                            <div class="flex flex-col justify-center">
                                <div
                                    class="inline-flex w-full gap-2 mb-2 justify-center bg-purple-600/20 px-4 py-1.5 rounded-xl">
                                    <svg class="fill-purple-600" width="34" height="34" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 0 494.446 494.446" xml:space="preserve">
                                        <g>
                                            <path
                                                d="M469.869,276.062h-97.34l-24.014-37.719c-0.687,0.016-1.325,0.104-2.016,0.104h-56.204l23.966,37.614H180.185
                                            ...
                                            <path
                                                d="M147.962,189.297h198.537c22.833,0,41.326-18.496,41.326-41.317c0-22.832-18.508-41.336-41.342-41.336H147.962
                                ...
                                <div class="flex gap-1 mb-2">
                                    <div
                                        class="px-0.5 w-fit bg-purple-500 rounded-full dark:text-orange-100 dark:bg-orange-500">
                                    </div>
                                    <p><span>Capacidad de la mesa: </span><strong>{{ $table->capaciodad }} personas</strong>
                                    </p>
                                </div>
