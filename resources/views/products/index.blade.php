                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                    <nav aria-label="Table navigation">
                        <ul class="inline-flex items-center">
                            <li>
                                <button onclick="window.location='{{ $products->previousPageUrl() }}'" :disabled="!products.prev_page_url"
                            ...
                            @endfor
                            <li>
                                <button onclick="window.location='{{ $products->nextPageUrl() }}'" :disabled="!products.next_page_url"
