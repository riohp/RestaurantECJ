                ...
                <div class="px-6 py-4 overflow-hidden">
                    <div class="flex flex-wrap md:flex-nowrap items-center justify-between gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <a href="{{ route('table_product.create') }}" class="py-2.5 px-4 inline-flex rounded-lg text-sm font-medium bg-purple-600 text-white transition-all hover:bg-purple-800">
