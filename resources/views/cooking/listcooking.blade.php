        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="p-6 dark:bg-gray-800 border-b border-b-default-200 dark:border-gray-600">
                <div class="flex flex-wrap justify-between items-center gap-4">
                    <div class="relative focus-within:text-purple-500">
                        ...
                        <form action="{{ route('cooking.listcooking') }}" method="GET">
                            @csrf
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Mostrando {{ $cookings->firstItem() }}-{{ $cookings->lastItem() }} de {{ $cookings->total() }}
                </span>
                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                    <nav aria-label="Table navigation">
                        <ul class="inline-flex items-center">
                             <li>
                                <button onclick="window.location='{{ $cookings->previousPageUrl() }}'"
                            ...
                            @for ($i = 1; $i <= $cookings->lastPage(); $i++)
                                <li>
                                    <button onclick="window.location='{{ $cookings->url($i) }}'"
                                        class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple {{ $cookings->currentPage() == $i ? 'bg-purple-600 text-white' : '' }}">
                                        {{ $i }}
                                    </button>
                                </li>
                            @endfor
                            <li>
                                <button onclick="window.location='{{ $cookings->nextPageUrl() }}'"
