...
@section('content-landing')
    <div class="relative h-full sm:py-5 lg:py-36 py-5 flex items-center bg-gradient-to-b justify-center from-purple-600/5 via-purple-600/5 to-purple-600/10 dark:bg-gray-900">
        <div class="container">
