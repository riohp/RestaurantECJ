        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                                ...
                                @forelse ($deliveries as $delivery)
                                    <tr class="">
                                        ...
                                        <td class="px-6 py-4 flex gap-3">
                                            <form action="{{ route('delivery.edit') }}" method="POST">
                                                @csrf
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Mostrando {{ $deliveries->firstItem() }}-{{ $deliveries->lastItem() }} de {{ $deliveries->total() }}
                </span>
                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                    <nav aria-label="Table navigation">
                        <ul class="inline-flex items-center">
                            <li>
                                <button onclick="window.location='{{ $deliveries->previousPageUrl() }}'"
                            ...
                            @for ($i = 1; $i <= $deliveries->lastPage(); $i++)
                                <li>
                                    <button onclick="window.location='{{ $deliveries->url($i) }}'"
                                        class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple {{ $deliveries->currentPage() == $i ? 'bg-purple-600 text-white' : '' }}">
                                        {{ $i }}
                                    </button>
                                </li>
                            @endfor
                            <li>
                                <button onclick="window.location='{{ $deliveries->nextPageUrl() }}'"
