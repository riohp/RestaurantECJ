...
@section('content-landing')
    ...
    <div class="relative w-full">
                ...
                <div class="flex flex-wrap items-center justify-between py-3 gap-6 md:py-4 md:gap-0">
                    ...
                    <div
                        ...
                        <div class="w-full space-y-2 border-yellow-200 lg:space-y-0 md:w-max lg:border-l">
                            <a type="button" title="Start buying" href="registration" class="w-full py-3 px-6 text-center rounded-full transition active:bg-yellow-200 focus:bg-yellow-100 sm:w-max">
                                <span class="block text-yellow-800 font-semibold text-sm">
                                    Sign up
                                </span>
                            </a>
                            <a type="button" title="Start buying" href="login" class="w-full py-3 px-6 text-center rounded-full transition bg-yellow-300 hover:bg-yellow-100 active:bg-yellow-400 focus:bg-yellow-300 sm:w-max">
        ...
        <div class="relative h-screen bg-yellow-50">
                ...
                <div class="flex items-center flex-wrap px-2 md:px-0">
                    <div class="relative lg:w-6/12 lg:py-24 xl:py-32">
                        ...
                        <form action="" class="w-full mt-12">
                            <div class="relative flex p-1 gap-2 rounded-full bg-white border border-yellow-200 shadow-md md:p-2">
                                ...
                                <button type="button" title="Start buying"
                                    class="ml-auto py-3 px-6 rounded-full text-center transition-all bg-gradient-to-b from-yellow-200 to-yellow-300 hover:to-red-300 active:from-yellow-400 focus:from-red-400 md:px-12">
